...
ALTER TABLE ONLY public.enroll_studentrequest_exchange_to DROP CONSTRAINT enroll_studentreques_studentrequest_id_84a368aa_fk_enroll_st;
ALTER TABLE ONLY public.enroll_studentrequest DROP CONSTRAINT enroll_studentreques_lecturer_id_4e795f0e_fk_enroll_le;
ALTER TABLE ONLY public.enroll_studentrequest DROP CONSTRAINT enroll_studentreques_enrollment_id_54853fa7_fk_enroll_en;
ALTER TABLE ONLY public.enroll_studentrequest_exchange_to DROP CONSTRAINT enroll_studentreques_classtime_id_38df45e4_fk_enroll_cl;
ALTER TABLE ONLY public.enroll_student DROP CONSTRAINT enroll_student_account_id_20bad8c2_fk_enroll_user_id;
...
ALTER TABLE ONLY public.enroll_enrollment DROP CONSTRAINT enroll_enrollment_student_id_da1bd0db_fk_enroll_student_id;
...
DROP INDEX public.enroll_studentrequest_lecturer_id_4e795f0e;
DROP INDEX public.enroll_studentrequest_exchange_to_studentrequest_id_84a368aa;
DROP INDEX public.enroll_studentrequest_exchange_to_classtime_id_38df45e4;
DROP INDEX public.enroll_studentrequest_enrollment_id_54853fa7;
DROP INDEX public.enroll_student_student_id_ec585306_like;
...
ALTER TABLE ONLY public.enroll_studentrequest DROP CONSTRAINT enroll_studentrequest_pkey;
ALTER TABLE ONLY public.enroll_studentrequest_exchange_to DROP CONSTRAINT enroll_studentrequest_exchange_to_pkey;
ALTER TABLE ONLY public.enroll_studentrequest_exchange_to DROP CONSTRAINT enroll_studentrequest_ex_studentrequest_id_classt_212086cd_uniq;
ALTER TABLE ONLY public.enroll_student DROP CONSTRAINT enroll_student_student_id_key;
ALTER TABLE ONLY public.enroll_student DROP CONSTRAINT enroll_student_pkey;
ALTER TABLE ONLY public.enroll_student DROP CONSTRAINT enroll_student_account_id_key;
...
ALTER TABLE public.enroll_studentrequest_exchange_to ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.enroll_studentrequest ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.enroll_student ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE public.enroll_studentrequest_id_seq;
DROP SEQUENCE public.enroll_studentrequest_exchange_to_id_seq;
DROP TABLE public.enroll_studentrequest_exchange_to;
DROP TABLE public.enroll_studentrequest;
DROP SEQUENCE public.enroll_student_id_seq;
DROP TABLE public.enroll_student;
...
--
-- Name: enroll_student; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.enroll_student OWNER TO postgres;

--
-- Name: enroll_student_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.enroll_student_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.enroll_student_id_seq OWNER TO postgres;

--
-- Name: enroll_student_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.enroll_student_id_seq OWNED BY public.enroll_student.id;


--
-- Name: enroll_studentrequest; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.enroll_studentrequest OWNER TO postgres;

--
-- Name: enroll_studentrequest_exchange_to; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.enroll_studentrequest_exchange_to (
    id integer NOT NULL,
    studentrequest_id integer NOT NULL,
    classtime_id integer NOT NULL
);


ALTER TABLE public.enroll_studentrequest_exchange_to OWNER TO postgres;

--
-- Name: enroll_studentrequest_exchange_to_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.enroll_studentrequest_exchange_to_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.enroll_studentrequest_exchange_to_id_seq OWNER TO postgres;

--
-- Name: enroll_studentrequest_exchange_to_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.enroll_studentrequest_exchange_to_id_seq OWNED BY public.enroll_studentrequest_exchange_to.id;


--
-- Name: enroll_studentrequest_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.enroll_studentrequest_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.enroll_studentrequest_id_seq OWNER TO postgres;

--
-- Name: enroll_studentrequest_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.enroll_studentrequest_id_seq OWNED BY public.enroll_studentrequest.id;
...
--
-- Name: enroll_student id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_student ALTER COLUMN id SET DEFAULT nextval('public.enroll_student_id_seq'::regclass);


--
-- Name: enroll_studentrequest id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest ALTER COLUMN id SET DEFAULT nextval('public.enroll_studentrequest_id_seq'::regclass);


--
-- Name: enroll_studentrequest_exchange_to id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest_exchange_to ALTER COLUMN id SET DEFAULT nextval('public.enroll_studentrequest_exchange_to_id_seq'::regclass);
...
INSERT INTO public.django_admin_log VALUES (52, '2021-05-20 08:48:38.521297+00', '1', 'Jan Gargas #123124', 1, '[{"added": {}}]', 14, 1);
INSERT INTO public.django_admin_log VALUES (53, '2021-05-20 08:48:50.592169+00', '10', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 10, 1);
INSERT INTO public.django_admin_log VALUES (54, '2021-05-20 08:49:30.487314+00', '2', 'Piotr (teacher)', 2, '[{"changed": {"fields": ["Password"]}}]', 7, 1);
INSERT INTO public.django_admin_log VALUES (55, '2021-05-20 08:49:33.805919+00', '3', 'Stanisław (student)', 2, '[{"changed": {"fields": ["Password"]}}]', 7, 1);
INSERT INTO public.django_admin_log VALUES (56, '2021-05-20 08:49:37.358322+00', '4', 'Kacper (student)', 2, '[{"changed": {"fields": ["Password"]}}]', 7, 1);
INSERT INTO public.django_admin_log VALUES (57, '2021-05-20 08:49:44.736185+00', '4', 'Kacper (student)', 2, '[]', 7, 1);
INSERT INTO public.django_admin_log VALUES (58, '2021-05-20 08:49:48.03898+00', '5', 'Jan (student)', 2, '[{"changed": {"fields": ["Password"]}}]', 7, 1);
INSERT INTO public.django_admin_log VALUES (59, '2021-05-20 08:49:51.641473+00', '6', 'Marcin (teacher)', 2, '[{"changed": {"fields": ["Password"]}}]', 7, 1);
INSERT INTO public.django_admin_log VALUES (60, '2021-05-20 08:51:57.419224+00', '1', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (93, '2021-05-20 09:28:19.358426+00', '34', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (94, '2021-05-20 09:29:50.935307+00', '34', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (95, '2021-05-20 09:29:50.938475+00', '1', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (96, '2021-05-20 09:30:51.278344+00', '35', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (97, '2021-05-20 09:33:00.60614+00', '35', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 2, '[{"changed": {"fields": ["Active"]}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (98, '2021-05-20 09:34:02.599251+00', '35', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (99, '2021-05-20 09:35:36.946468+00', '36', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (100, '2021-05-20 09:37:52.808107+00', '36', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (101, '2021-05-20 09:39:25.544233+00', '37', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (102, '2021-05-20 09:39:41.091808+00', '37', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (103, '2021-05-20 09:40:04.804728+00', '38', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (104, '2021-05-20 09:55:33.709737+00', '38', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (105, '2021-05-20 09:56:12.079433+00', '39', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | MONDAY 08:00', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (106, '2021-05-20 09:58:12.390075+00', '40', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | TUESDAY 09:30', 1, '[{"added": {}}]', 13, 1);
INSERT INTO public.django_admin_log VALUES (107, '2021-05-20 10:46:27.354907+00', '41', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | TUESDAY 09:30', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (108, '2021-05-20 10:46:27.35807+00', '40', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | TUESDAY 09:30', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (109, '2021-05-20 10:46:27.359946+00', '39', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | TUESDAY 09:30', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES (110, '2021-05-20 10:46:40.545864+00', '42', 'Jan Gargas #123124 - Algorytmy dla Problemów Trudnych Obliczeniowo | TUESDAY 09:30', 3, '', 13, 1);
INSERT INTO public.django_admin_log VALUES
Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.enroll_student VALUES (1, 'Jan', 'Gargas', '123124', 5);
INSERT INTO public.enroll_student VALUES (2, 'Kacper', 'Karoń', '131231', 4);
INSERT INTO public.enroll_student VALUES (3, 'Stanisław', 'Denkowski', '343431', 3);


--
-- Data for Name: enroll_studentrequest; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- Data for Name: enroll_studentrequest_exchange_to; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO public.enroll_user VALUES (2, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-05-20 10:50:20.535772+00', false, 'Piotr', 'Piotr', 'Faliszewski', 'piotr@faliszewski.pl', false, true, '2021-04-12 20:30:44+00', 3);
INSERT INTO public.enroll_user VALUES (6, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-05-20 10:50:29.311922+00', false, 'Marcin', 'Marcin', 'Kurdziel', 'marcin@kurdziel.pl', false, true, '2021-04-13 14:21:34+00', 3);
INSERT INTO public.enroll_user VALUES (3, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-04-13 16:13:08+00', false, 'Stanisław', 'Stanisław', 'Denkowski', 'stanislaw@denkowski.pl', false, true, '2021-04-12 20:33:17+00', 2);
INSERT INTO public.enroll_user VALUES (5, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-05-20 10:50:50.581952+00', false, 'Jan', 'Jan', 'Gargas', 'jan@gargas.pl', false, true, '2021-04-13 14:20:53+00', 2);
INSERT INTO public.enroll_user VALUES (4, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-04-13 14:20:11+00', false, 'Kacper', 'Kacper', 'Karoń', 'kacper@karon.pl', false, true, '2021-04-13 14:20:04+00', 2);
INSERT INTO public.enroll_user VALUES (1, 'pbkdf2_sha256$260000$4uuf3xTiTNzRlHr6i9iSc0$QUq4C0D1GUZNJYJdZHELHNdqSZfiX73/2gc4x5Ox/+A=', '2021-05-20 10:55:09.248592+00', true, 'admin', '', '', 'admin@myproject.com', true, true, '2021-05-20 07:57:01.672407+00', 1);
...
SELECT pg_catalog.setval('public.enroll_enrollment_id_seq', 10, true);
...
SELECT pg_catalog.setval('public.enroll_offer_exchange_to_id_seq', 8, true);
...
SELECT pg_catalog.setval('public.enroll_offer_id_seq', 6, true);


--
-- Name: enroll_student_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.enroll_student_id_seq', 3, true);


--
-- Name: enroll_studentrequest_exchange_to_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.enroll_studentrequest_exchange_to_id_seq', 43, true);


--
-- Name: enroll_studentrequest_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.enroll_studentrequest_id_seq', 43, true);
...
SELECT pg_catalog.setval('public.enroll_user_id_seq', 111, true);
...
--
-- Name: enroll_student enroll_student_account_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_student
    ADD CONSTRAINT enroll_student_account_id_key UNIQUE (account_id);


--
-- Name: enroll_student enroll_student_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_student
    ADD CONSTRAINT enroll_student_pkey PRIMARY KEY (id);


--
-- Name: enroll_student enroll_student_student_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_student
    ADD CONSTRAINT enroll_student_student_id_key UNIQUE (student_id);


--
-- Name: enroll_studentrequest_exchange_to enroll_studentrequest_ex_studentrequest_id_classt_212086cd_uniq; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest_exchange_to
    ADD CONSTRAINT enroll_studentrequest_ex_studentrequest_id_classt_212086cd_uniq UNIQUE (studentrequest_id, classtime_id);


--
-- Name: enroll_studentrequest_exchange_to enroll_studentrequest_exchange_to_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest_exchange_to
    ADD CONSTRAINT enroll_studentrequest_exchange_to_pkey PRIMARY KEY (id);


--
-- Name: enroll_studentrequest enroll_studentrequest_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest
    ADD CONSTRAINT enroll_studentrequest_pkey PRIMARY KEY (id);
...
--
-- Name: enroll_student_student_id_ec585306_like; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX enroll_student_student_id_ec585306_like ON public.enroll_student USING btree (student_id varchar_pattern_ops);


--
-- Name: enroll_studentrequest_enrollment_id_54853fa7; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX enroll_studentrequest_enrollment_id_54853fa7 ON public.enroll_studentrequest USING btree (enrollment_id);


--
-- Name: enroll_studentrequest_exchange_to_classtime_id_38df45e4; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX enroll_studentrequest_exchange_to_classtime_id_38df45e4 ON public.enroll_studentrequest_exchange_to USING btree (classtime_id);


--
-- Name: enroll_studentrequest_exchange_to_studentrequest_id_84a368aa; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX enroll_studentrequest_exchange_to_studentrequest_id_84a368aa ON public.enroll_studentrequest_exchange_to USING btree (studentrequest_id);


--
-- Name: enroll_studentrequest_lecturer_id_4e795f0e; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX enroll_studentrequest_lecturer_id_4e795f0e ON public.enroll_studentrequest USING btree (lecturer_id);
...
--
-- Name: enroll_enrollment enroll_enrollment_student_id_da1bd0db_fk_enroll_student_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_enrollment
    ADD CONSTRAINT enroll_enrollment_student_id_da1bd0db_fk_enroll_student_id FOREIGN KEY (student_id) REFERENCES public.enroll_student(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: enroll_student enroll_student_account_id_20bad8c2_fk_enroll_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_student
    ADD CONSTRAINT enroll_student_account_id_20bad8c2_fk_enroll_user_id FOREIGN KEY (account_id) REFERENCES public.enroll_user(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: enroll_studentrequest_exchange_to enroll_studentreques_classtime_id_38df45e4_fk_enroll_cl; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest_exchange_to
    ADD CONSTRAINT enroll_studentreques_classtime_id_38df45e4_fk_enroll_cl FOREIGN KEY (classtime_id) REFERENCES public.enroll_classtime(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: enroll_studentrequest enroll_studentreques_enrollment_id_54853fa7_fk_enroll_en; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest
    ADD CONSTRAINT enroll_studentreques_enrollment_id_54853fa7_fk_enroll_en FOREIGN KEY (enrollment_id) REFERENCES public.enroll_enrollment(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: enroll_studentrequest enroll_studentreques_lecturer_id_4e795f0e_fk_enroll_le; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest
    ADD CONSTRAINT enroll_studentreques_lecturer_id_4e795f0e_fk_enroll_le FOREIGN KEY (lecturer_id) REFERENCES public.enroll_lecturer(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: enroll_studentrequest_exchange_to enroll_studentreques_studentrequest_id_84a368aa_fk_enroll_st; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.enroll_studentrequest_exchange_to
    ADD CONSTRAINT enroll_studentreques_studentrequest_id_84a368aa_fk_enroll_st FOREIGN KEY (studentrequest_id) REFERENCES public.enroll_studentrequest(id) DEFERRABLE INITIALLY DEFERRED;
